...
class DataTableViewOfHeader: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let labels:[tableViewCellCustomLabel] = [glucoseLabel,eventLabel,appetiteLabel,insulinLabel,weightLabel,heightLabel,bloodPressureLabel,medicineLabel,sportLabel]
