...
class dataTableViewCell: UITableViewCell {
    ...
    private lazy var glucoseLabel:UILabel = UILabel()
    private lazy var eventLabel:UILabel = UILabel()
    private lazy var appetiteLabel:UILabel = UILabel()
    private lazy var isulinLabel:UILabel = UILabel()
    
//    var heightLabel:UILabel = UILabel()
    private lazy var weightLabel:UILabel = UILabel()
    private lazy var bloodPressureLabel:UILabel = UILabel()
    private lazy var medicineLabel: UILabel = UILabel()
    private lazy var sportLabel:UILabel = UILabel()
    private lazy var modelLabel:UILabel = UILabel()
    private lazy var remarkLabel:UILabel = UILabel()
...
//        }
        ...
        initContent(secion: secion, row: row)
    ...
    func initContent(secion:Int,row:Int){
        // 血糖
        // 如果血糖不为空
        if let gluBlood = sortedData[secion][row].bloodGlucoseMmol{
            // 根据单位设置不同形式的值
